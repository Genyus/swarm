...
vi.mock('@ingenyus/swarm-core/utils/filesystem', () => ({
  ...
  findWaspRoot: vi.fn().mockImplementation((fileSystem: any, startDir?: string) => {
...
vi.mock('@ingenyus/swarm-core/utils/prisma', () => ({
...
vi.mock('@ingenyus/swarm-core/utils/templates', () => ({
...
`;
  ...
  describe('Route Creation', () => {
    ...
    it('should create a route with default settings', async () => {
      await routeGenerator.generate({ featurePath: 'documents', flags: {
        path: '/documents',
        force: false,
      }});
    ...
    it('should handle duplicate route creation without force', async () => {
      ...
      await expect(
        routeGenerator.generate({ featurePath: 'documents', flags: {
          path: '/documents',
          force: false,
        }})
  ...
  describe('API Creation', () => {
    ...
    it('should create an API endpoint', async () => {
      await apiGenerator.generate({ featurePath: 'documents', flags: {
        name: 'searchApi',
        method: 'GET',
  ...
  describe('Job Creation', () => {
    ...
    it('should create a scheduled job', async () => {
      await jobGenerator.generate({ featurePath: 'documents', flags: {
  ...
  describe('CRUD Operations', () => {
    ...
    it('should create a complete CRUD set', async () => {
      await crudGenerator.generate({ featurePath: 'documents', flags: {
        dataType: 'Document',
        force: false,
      }});
  ...
  describe('Operation Creation (Queries & Actions)', () => {
    ...
    it('should create a query operation', async () => {
      await operationGenerator.generate({ featurePath: 'documents', flags: {
        dataType: 'Document',
        operation: 'get',
        entities: 'Document',
        auth: false,
  ...
  describe('API Namespace Creation', () => {
    ...
    it('should create an API namespace with middleware', async () => {
      await apiNamespaceGenerator.generate({ featurePath: 'documents', flags: {
        name: 'api',
        path: '/api',
        force: false,
      }});
  ...
  describe('Error Handling', () => {
    it('should handle missing feature directory', async () => {
      ...
      try {
        await routeGenerator.generate({ featurePath: 'nonexistent', flags: {
          path: '/test',
          force: false,
        }});
    ...
    it('should handle duplicate CRUD creation without force', async () => {
      ...
      await expect(
        ...
        crudGenerator.generate({ featurePath: 'documents', flags: {
          dataType: 'Document',
          override: ['get', 'getAll'],
          force: false,
        }})
    ...
    it('should handle duplicate API creation without force', async () => {
      ...
      await expect(
        apiGenerator.generate({ featurePath: 'documents', flags: {
          name: 'searchApi',
          method: 'GET',
          route: '/api/documents/search',
          entities: ['Document'],
    ...
    it('should handle duplicate job creation without force', async () => {
      ...
      // Try to create again without force - should throw error
      await expect(
        jobGenerator.generate({ featurePath: 'documents', flags: {
          name: 'archiveDocuments',
          entities: ['Document'],
          force: false,
        }})
    ...
    it('should handle duplicate operation creation without force', async () => {
      ...
      // Try to create again without force - should throw error
      await expect(
        operationGenerator.generate({ featurePath: 'documents', flags: {
          dataType: 'Document',
          operation: 'get',
          entities: 'Document',
          auth: false,
    ...
    it('should handle duplicate API namespace creation without force', async () => {
      ...
      // Try to create again without force - should throw error
      await expect(
        apiNamespaceGenerator.generate({ featurePath: 'documents', flags: {
          name: 'api',
          path: '/api',
          force: false,
        }})
