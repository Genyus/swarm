...
> {
  ...
  withEntities(): CommandBuilder<T, U & { entities?: string }> {
    ...
    ) as Command<T, U & { entities?: string }>;
    return new CommandBuilder(newCmd);
  }
